...
validation_expect_same('8599266494', normalize_whatsapp('+55 85 9926-6494'), 'celular legado com DDI');
validation_expect_same('8598158188', normalize_whatsapp('+55 85 9815-8188'), 'celular legado nacional');
...
validation_expect_throws(fn () => normalize_whatsapp('8579266494'), 'prefixo legado inválido');
validation_expect_throws(fn () => normalize_whatsapp('8589266494'), 'prefixo legado inválido');
